      ...
      for (sub_folder in sub_folders){
        for (min_overlap in min_overlap_range){
          for (background_folder in background_folders){
            ...
            data_and_results_path <- get_results_path(main_path,opt_input_data,cluster_folder,min_overlap,background_folder,sub_folder,MT_subfolder,opt_metacell_settings)
...
get_results_path <- function(main_path,opt_input_data,cluster_folder,min_overlap,background_folder,sub_folder,opt_metacell_settings){
  if (opt_input_data == "DEG_GSA_result"|| opt_input_data == "DEG_GSA_and_GRN_modules_gprofiler_result" || opt_input_data == "DEG_GSA_result_all_CTs"){
    ...
    data_and_results_path <- paste0(main_path,'/output/cluster_name_15CTs/scz/cor_bicor/variable/',MT_sf,cluster_folder,sub_folder)
  } else if (opt_input_data == "all_GRN_modules_gprofiler_result" || opt_input_data == "all_bordeaux_modules_gprofiler_result"){
    data_and_results_path <- paste0(main_path,'/output/cluster_name_15CTs/scz/cor_bicor/variable/',MT_sf)
  } else if(opt_input_data =="longread_results"){
    ...
    data_and_results_path <- paste0(main_path,"output/cluster_name_15CTs/scz/cor_bicor/GSA_results/variable/",MT_sf,sub_folder)
  } 
