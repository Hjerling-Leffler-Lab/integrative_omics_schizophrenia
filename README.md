...
## Transcriptomic and genetic analysis suggests a causal role for mitochondrial dysregulation in schizophrenia ##
...
The numbering in folder and file names indicate in which order to run the code. The software_info.xlsx file contains software and package version info for respective code folders.
